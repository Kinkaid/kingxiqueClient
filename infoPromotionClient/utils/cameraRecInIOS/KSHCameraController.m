...
//            }
            ...
            int nResultLen = BankCardNV12(result, 512, bufferPtr, width, height, rect.origin.x, rect.origin.y, rect.origin.x+rect.size.width, rect.origin.y+rect.size.height);
