 ...
 */
//#define DEFAULT_BUCKET @"magpie-pic"
#define DEFAULT_BUCKET @"test-magpie-pic"
/**
 *	@brief	默认表单API功能密钥 （必填项），可在init之后修改passcode的值来更改
 */
//#define DEFAULT_PASSCODE @"3oRBq/ivoR3qDEDrKE15Lajj3tE="
#define DEFAULT_PASSCODE @"FHDWG0Ti+6hUScf5g2D9z7pPxhQ="
