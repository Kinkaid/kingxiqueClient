...
- (NSMutableDictionary *)sendPay_demo2:(NSString *)trade_id{
    NSMutableDictionary *signParams = [NSMutableDictionary dictionary];
    
    ServiceManager *manager = [ServiceManager sharedInstance];
    NSDictionary *params = @{@"user_id":[TDUserDefaultsUtil getCustomerId],@"trade_id":trade_id};
    [manager postFunction:@"/wx/pay/app/sign" params:params attributes:nil success:^(AFHTTPRequestOperation *operation, id responseObject, NSDictionary *data) {
