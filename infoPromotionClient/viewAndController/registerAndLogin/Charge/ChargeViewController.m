...
-(void)zfbPay{
    ...
    NSDictionary *params = @{@"shop_id":[TDUserDefaultsUtil getCustomerId],@"user_id":[TDUserDefaultsUtil getCustomerId],@"change":[TDDataUtil parseStrPriceToParamPrice:amount],@"pay_channel":[[NSNumber alloc] initWithInt:CsPayChannelIsAlipay]};
...
-(void)wxPay{
    ...
    ServiceManager *manager = [ServiceManager sharedInstance];
    NSDictionary *params = @{@"shop_id":[TDUserDefaultsUtil getShopId],@"user_id":[TDUserDefaultsUtil getCustomerId],@"change":[TDDataUtil parseStrPriceToParamPrice:amount],@"pay_channel":[[NSNumber alloc] initWithInt:CsPayChannelIsWXApp]};
