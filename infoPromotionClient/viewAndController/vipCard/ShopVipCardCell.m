...
@implementation ShopVipCardCell
...
{
    [self initCardItemWithCardType:[dic[@"cardType"] intValue]];
}
-(void)initCardItemWithCardType:(int)cardType
{
    switch (cardType) {
        case 1:
        {
...
-(void)initWithCardNameLeftImage:(UIImage *)leftImage AndRightImage:(UIImage *)rightImage AndCardNameLabelColor:(UIColor *)labelBackgroundColor AndDownViewColor:(UIColor *)downViewColor AndCardImage:(UIImage*)cardImage
{
    ...
    self.moneySignalLabel.textColor = downViewColor;
    self.monayLabel.textColor = downViewColor;
    self.yuanWordLabel.textColor = downViewColor;
    self.faceValueLabel.textColor = downViewColor;
    self.surplusLabel.textColor = labelBackgroundColor;
